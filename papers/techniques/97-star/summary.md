...
tags: ["reasoning", "self-improvement", "synthetic-data"]
---
...
By early 2022, Chain-of-Thought prompting (#9) had shown that asking a model to "think step by step" before answering substantially improved performance on math and reasoning. But CoT had limits:
...
This is a kind of **rejection sampling fine-tuning** - a technique that reappears in RLHF (#5) and in modern RL pipelines as a strong baseline before adding full PPO/GRPO.
...
- **Chain-of-Thought (#9):** STaR's foundation. CoT showed that reasoning traces help; STaR showed you can train *on* reasoning traces, generated by the model itself.
...
- [Meta Chain-of-Thought: Towards System 2 Reasoning in LLMs](../../techniques/34-meta-cot/summary.md)
