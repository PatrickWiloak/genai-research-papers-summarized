...
tags: ["reinforcement-learning", "search", "self-play"]
---
...
- **AlphaFold 2 (#68) and AlphaFold 3 (#101)** - sibling DeepMind systems. Different domain, same underlying philosophy: deep networks with strong domain-appropriate inductive biases and learned policies.
...
- **Self-Consistency (#77) and Tree of Thoughts (#25)** - inference-time analogues of AlphaZero's MCTS, with the LLM in the role of both policy and value network.
