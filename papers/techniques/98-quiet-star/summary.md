...
tags: ["reasoning", "self-improvement", "pretraining"]
---
...
|---|---|---|---|
| **Chain-of-Thought (#9)** | At inference, prompted | Yes (in output) | No |
| **STaR (#97)** | At inference + training | Yes (in output) | Yes (fine-tune) |
...
- **STaR (#97):** Direct predecessor. STaR is "outcome-supervised reasoning on QA tasks"; Quiet-STaR is "next-token-supervised reasoning on arbitrary text."
- **Chain-of-Thought (#9):** Quiet-STaR makes the chain of thought internal and automatic rather than prompted and visible.
...
- **Mistral 7B (#95):** The base model Quiet-STaR builds on.
