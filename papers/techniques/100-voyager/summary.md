...
tags: ["agents", "tool-use", "self-improvement", "code"]
---
...
- **Self-Refine (#99)** - Voyager's iterative prompting with environment errors is essentially Self-Refine specialized to embodied code generation.
...
- **Chain-of-Thought (#9) / Self-Consistency (#77)** - Voyager relies on CoT-style reasoning inside each skill-writing prompt.
...
- **AlphaZero (#102)** - both Voyager and AlphaZero achieve open-ended skill mastery without human demonstrations, but via very different mechanisms (LLM curriculum vs. self-play RL).
