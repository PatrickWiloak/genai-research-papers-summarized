...
ALIASES: dict[str, list[str]] = {
    ...
    "69-classifier-free-guidance": ["classifier-free guidance", "Classifier-Free Guidance", "guidance scale", "CFG"],
    "70-ddim": ["DDIM"],
    "71-controlnet": ["ControlNet"],
    "72-flow-matching-sd3": ["flow matching", "Flow Matching", "rectified flow", "Rectified Flow", "Stable Diffusion 3", "SD3", "MMDiT"],
    "73-resnet": ["ResNet", "residual connection", "residual connections", "Deep Residual"],
    "74-unet": ["U-Net", "UNet"],
    "75-grouped-query-attention": ["Grouped-Query Attention", "grouped-query attention", "GQA", "Multi-Query Attention", "multi-query attention", "MQA", "KV cache", "KV-cache"],
    "76-zero-megatron": ["ZeRO", "Megatron", "Megatron-LM", "tensor parallel", "pipeline parallel", "FSDP", "DeepSpeed"],
    "77-self-consistency": ["Self-Consistency", "self-consistency", "majority vote", "majority voting"],
    "78-reflexion": ["Reflexion"],
    "79-self-instruct": ["Self-Instruct", "self-instruct", "Alpaca"],
    "80-flan": ["FLAN", "Flan-T5", "Flan-PaLM", "instruction tuning", "Instruction tuning"],
    "81-emergent-abilities": ["emergent abilities", "Emergent Abilities", "emergent ability"],
    "82-sparse-autoencoders": ["sparse autoencoder", "Sparse Autoencoder", "sparse autoencoders", "SAE", "monosemanticity", "Monosemanticity", "superposition", "mechanistic interpretability"],
    "83-sleeper-agents": ["Sleeper Agents", "sleeper agent", "deceptive alignment"],
    "84-swe-bench": ["SWE-bench", "SWE-Bench", "SWE-agent"],
    "85-llm-as-judge": ["LLM-as-a-judge", "LLM-as-judge", "LLM judge", "judge model", "MT-Bench", "Chatbot Arena"],
    "86-gptq-awq-quantization": ["GPTQ", "AWQ", "GGUF", "post-training quantization"],
    "87-dense-retrieval": ["Dense Passage Retrieval", "DPR", "ColBERT", "Sentence-BERT", "bi-encoder", "cross-encoder", "BM25", "reranker"],
    "88-mae": ["Masked Autoencoder", "masked autoencoder", "MAE", "masked image modeling"],
    "89-vq-vae": ["VQ-VAE", "vector quantization", "Vector Quantization", "discrete latent"],
    "90-vq-gan": ["VQ-GAN", "VQGAN", "Taming Transformers"],
    "91-imagen": ["Imagen"],
    "92-dreambooth": ["DreamBooth", "subject-driven generation"],
    "93-gpt1": ["GPT-1", "Generative Pre-Training"],
    "94-palm": ["PaLM", "Pathways"],
    "95-mistral-7b": ["Mistral 7B", "Mistral-7B", "sliding window attention"],
    "96-llama-guard": ["Llama Guard", "LlamaGuard"],
    "97-star": ["STaR", "Self-Taught Reasoner", "rationalization"],
    "98-quiet-star": ["Quiet-STaR"],
    "99-self-refine": ["Self-Refine", "self-refinement", "iterative refinement"],
    "100-voyager": ["Voyager", "skill library"],
    "101-alphafold3": ["AlphaFold 3", "AlphaFold3"],
    "102-alphazero": ["AlphaZero", "AlphaGo Zero", "self-play"],
    "103-kto": ["KTO", "Kahneman-Tversky Optimization", "prospect theor"],
    "104-genie": ["Genie", "generative interactive environment"],
    "105-dreamerv3": ["DreamerV3", "Dreamer", "world model", "World Model"],
    "106-esm": ["ESM-2", "ESMFold", "ESM", "protein language model"],
    "107-cicero": ["CICERO", "Diplomacy"],
}
